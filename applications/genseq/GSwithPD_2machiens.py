...
if __name__ == "__main__":
    ...
    pilots.append({ "service_url": 'pbs-ssh://india.futuregrid.org',
                       ...
                       "input_dir":'/N/u/pmantha/gen_data/1GB',
                       "temp_dir":'/N/u/pmantha/temp',
                       "output_dir":'/N/u/pmantha/output',
                       "chunker":os.getcwd()+'/applications/genseq/gen_chunk.sh',
                       "chunk_arguments":[ "1171052" ],
                       "mapper":os.getcwd()+'/applications/genseq/gen_map_partition.py',
                       "map_arguments":["/N/u/pmantha/hg/hg19.fa"],
                       "reducer":os.getcwd()+'/applications/genseq/gen_reduce.py',
                       "reduce_arguments":[],
    ...
    pilots.append({ "service_url": 'pbs-ssh://hotel.futuregrid.org',
                       ...
                       "input_dir":'/gpfs/scratch/pmantha/gen_data/1GB',
                       "temp_dir":'/gpfs/scratch/pmantha/temp',
                       "output_dir":'/gpfs/scratch/pmantha/output',
                       "chunker":os.getcwd()+'/applications/genseq/gen_chunk.sh',
                       "chunk_arguments":[ "1171052" ],
                       "mapper":os.getcwd()+'/applications/genseq/gen_map_partition.py',
                       "map_arguments":["/gpfs/scratch/pmantha/hg/hg19.fa"],
                       "reducer":os.getcwd()+'/applications/genseq/gen_reduce.py',
                       "reduce_arguments":[],
                       "pilot_store":'/gpfs/scratch/pmantha/temp'
                      })

    """pilots.append({ "service_url": 'pbs-ssh://sierra.futuregrid.org',
                       "map_number_of_processes":128,
                       'processes_per_node':8,
                       "reduce_number_of_processes":32,
                       ...
                       "input_dir":'/N/scratch/pmantha/gen_data/',
                       "temp_dir":'/N/scratch/pmantha/temp',
                       "output_dir":'/N/scratch/pmantha/output',
                       "chunker":'/N/scratch/pmantha/genseq/gen_chunk.sh',
                       "chunk_arguments":[ "1171052" ],
                       "mapper":'/N/scratch/pmantha/genseq/gen_map_partition.py',
                       "map_arguments":["/N/scratch/pmantha/hg/hg19bwa"],
                       "reducer":'/N/scratch/pmantha/genseq/gen_reduce.py',
                       "reduce_arguments":[],
                       "pilot_store":'/N/scratch/pmantha/temp/'
                      })"""
                      
    chunk_type = 2
    mr = MapReduce(pilots,8,"4","redis://ILikeBigJob_wITH-REdIS@gw68.quarry.iu.teragrid.org:6379",chunk_type)
    mr.MapReduceMain()
