...
def main():
    ...
    parser.add_option("-g", "--map_arguments", dest="maparg", default=None,
                  help="provide the arguments to the mapper function delimited with ,")
    parser.add_option("-k", "--reduce-arguments", dest="redarg", default=None,
                  help="provide the arguments to the reduce function delimited with ,")
    ...
    fsp = MapReduce(options.input,options.output_dir,options.temp_dir,options.nbr_reduces,options.mapper,options.reducer,options.advert_host,options.resource_url,options.number_nodes,options.queue, options.allocation, options.walltime, options.ppn, options.workingdirectory, options.userproxy, options.chunk, options.npworkers,options.maparg, options.redarg)
