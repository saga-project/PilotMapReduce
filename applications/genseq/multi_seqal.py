...
if __name__ == "__main__":
    ...
    pmr_spec.append({ # Machine specific parameters
                    "pj_service_url": 'pbs+ssh://india.futuregrid.org',
                    "working_directory": os.getcwd()+'/agent',
                    "affinity_datacenter_label": 'eu-de-south-1',
                    "affinity_machine_label": 'mymachine-1',
                    "input":'sftp://india.futuregrid.org/N/u/pmantha/gen_input/1GB',
    ...
    mr.map_number_of_processes=2
    mr.reduce_number_of_processes=2
    mr.chunk="ssh://localhost/" + os.getcwd()+'/seqal_chunk.sh'
    mr.mapper="ssh://localhost/" + os.getcwd()+'/seqal_map_partition.py'
    mr.reducer="ssh://localhost/" + os.getcwd()+'/seqal_reduce.py'
    mr.chunk_type=2
