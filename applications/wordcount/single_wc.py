...
if __name__ == "__main__":
    ...
    mr.chunk="ssh://localhost/" + os.getcwd()+'/wordcount_chunk.sh'
    mr.mapper="ssh://localhost/" + os.getcwd()+'/wordcount_map_partition.py'
    mr.reducer="ssh://localhost/" + os.getcwd()+'/wordcount_reduce.py'
    mr.chunk_type=1
